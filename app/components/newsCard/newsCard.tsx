...
export default function NewsCard({ art }: NewsCardProps) {
    const clean = cleanTitle(art.title);

    return (
        <div className="max-w-sm m-5 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <img className="rounded-t-lg" src={art?.urlToImage} alt="" />
            </a>
            <div className="p-5">
                <a href="#">
                    <h5 className="mb-2 text-2xl font-bold tracking-tigh text-gray-900 dark:text-white">{clean}</h5>
                </a>
